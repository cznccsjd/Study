...
public final class StdInLocal {
    ...
    private static void setScanner(Scanner scanner) {
        StdInLocal.scanner = scanner;
        StdInLocal.scanner.useLocale(LOCALE);
    }
    ...
    public static void main(String[] args) {
        ...
        StdOutLocal.print("Type a string: ");
        String s = StdInLocal.readString();
        StdOutLocal.println("Your string was: " + s);
        StdOutLocal.println();

        StdOutLocal.print("Type an int: ");
        int a = StdInLocal.readInt();
        StdOutLocal.println("Your int was: " + a);
        StdOutLocal.println();

        StdOutLocal.print("Type a boolean: ");
        boolean b = StdInLocal.readBoolean();
        StdOutLocal.println("Your boolean was: " + b);
        StdOutLocal.println();

        StdOutLocal.print("Type a double: ");
        double c = StdInLocal.readDouble();
        StdOutLocal.println("Your double was: " + c);
        StdOutLocal.println();
    }
