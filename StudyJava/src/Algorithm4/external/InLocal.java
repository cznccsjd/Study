...
public final class InLocal {
     ...
     */
    public InLocal(Scanner scanner) {
    ...
    public static int[] readInts(String filename) {
        return new InLocal(filename).readAllInts();
    }
    ...
    public static double[] readDoubles(String filename) {
        return new InLocal(filename).readAllDoubles();
    }
    ...
    public static String[] readStrings(String filename) {
        return new InLocal(filename).readAllStrings();
    }
    ...
    public static int[] readInts() {
        return new InLocal().readAllInts();
    }
    ...
    public static double[] readDoubles() {
        return new InLocal().readAllDoubles();
    }
    ...
    public static String[] readStrings() {
        return new InLocal().readAllStrings();
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("---------------------------------------------------------------------------");
        try {
            in = new InLocal("../stdlib/InTest.txt");
            while (!in.isEmpty()) {
                String s = in.readLine();
                System.out.println(s);
            }
        ...
        System.out.println("---------------------------------------------------------------------------");
        try {
            in = new InLocal("/n/fs/introcs/www/java/stdlib/InTest.txt");
            while (!in.isEmpty()) {
                String s = in.readLine();
                System.out.println(s);
            }
        ...
        System.out.println("---------------------------------------------------------------------------");
        try {
            in = new InLocal("G:\\www\\introcs\\stdlib\\InTest.txt");
            while (!in.isEmpty()) {
                String s = in.readLine();
                System.out.println(s);
            }
