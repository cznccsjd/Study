...
def saizi():
    ...
    #客人押的钱
    money = randrange(10,1000,5)     #   取随机数，def randrange(self, start, stop=None, step=1, _int=int):
    print("本次赌注是：",money)
    ...
    ###################下面的nonlocal全局变量定义的应该有问题，后面有时间再改吧
    # nonlocal money_zhuang
    # nonlocal money_keren
    nonlocal num
    ...
    if(mon_keren < 10):
        ...
        print("庄家余额",mon_zhuang,"不足10元，不让玩了")
    else:
        print("钱还多着呢，继续嗨皮！")
        print("*******************************************")
        print("\n")
